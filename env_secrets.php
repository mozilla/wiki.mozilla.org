...
$SECRETS_wgDBpassword             = getenv('SECRETS_wgDBpassword');
$SECRETS_wgSecretKey              = getenv('SECRETS_wgSecretKey');
$SECRETS_wgUpgradeKey             = getenv('SECRETS_wgUpgradeKey');
$SECRETS_wgReCaptchaPublicKey     = getenv('SECRETS_wgReCaptchaPublicKey');
